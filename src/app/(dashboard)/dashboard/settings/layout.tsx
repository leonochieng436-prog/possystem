...
const SETTINGS_GROUPS = [
  {
    ...
    items: [
      ...
      { href: "/dashboard/settings?section=business", label: "Business profile", description: "Business identity and contact details", icon: "business", permission: "SETTINGS_MANAGE", available: true },
      ...
      { href: "/dashboard/settings?section=locations", label: "Warehouses", description: "Stock locations by branch", icon: "warehouses", permission: "INVENTORY_VIEW", available: true },
    ],
  },
  {
    label: "Operations",
  ...
  },
  {
    ...
    items: [
      ...
      { href: "/dashboard/settings?section=roles", label: "Roles & permissions", description: "Control what each role can do", icon: "roles", permission: "ROLES_MANAGE", available: true },
      { href: "/dashboard/settings?section=security", label: "Security", description: "Sessions and account protection", icon: "security", permission: "SETTINGS_MANAGE", available: true },
    ],
  },
  {
    ...
    items: [
      ...
      { href: "/dashboard/settings?section=audit", label: "Audit logs", description: "Review sensitive business activity", icon: "audit", permission: "AUDIT_LOG_VIEW", available: true },
      { href: "/dashboard/settings?section=data", label: "Data & backup", description: "Data health and export status", icon: "data", permission: "SETTINGS_MANAGE", available: true },
...
export default async function SettingsLayout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="mx-auto grid max-w-6xl gap-8 lg:min-h-full lg:grid-cols-[220px_1fr]">
      <aside className="scrollbar-hidden lg:sticky lg:top-0 lg:max-h-[calc(100vh-3rem)] lg:overflow-y-auto lg:border-r lg:border-border lg:pr-5">
        <div className="mb-6">
